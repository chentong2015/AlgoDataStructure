package work_algorithms.dp_algo.two_dimension;

public class DpTwoDimension2 {
    ...
    //
    // strs = ["10","0001","111001","1","0"], m = 5/0, n = 3/1
    //   -> {"10", "0001", "1", "0"} 最大的组合子集，可以取到4个Element
    // strs = ["10","0","1"], m = 1/0, n = 1/1
    //   -> {"0", "1"} 要取最多的子集元素
    // strs = ["111","1000","1000","1000"], m = 9/0, n = 1/1
    //   -> {"1000","1000","1000"}
    //
    // 如何提取最佳的组合方式，让选出来的字元素最多 ? 从长度小的元素开始选
    //   => 自定义排序的比较器 O(nlog(n))
