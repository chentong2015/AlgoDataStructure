...
public class ReversedStringManipulation {

    // TODO. 将字符串换成它的反转字符串，只需将字符中与“反转字符串序列”不匹配的字符”甩“到末尾重新组合
    //  要移动的步数将是”甩“到末尾的字符数目，每次只要”甩“的是正确的字符，一次成功的步数一定最小
    //  根本无需关心中途如何选择字符，中途如何重组移动每一步的新字符串，移动的过程不重要 ！！
    //
    // String Manipulation.
